...
<nav style="background-color:#DAD4E4;" class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="admincategories.php">Categories</a>
        </li>
        <li class="nav-item">
...
<p>Available Categories in the database are as follows: </p>
...
include('info/categories.php');

?>
<br>
<form action="deletecategory.php" method="POST">
<label for="ids">Please choose a category id from the list to delete from the database</label>
<br>
<select name="ids">
...
$sql_command = "SELECT category_id FROM categories";

$myresult = mysqli_query($db, $sql_command);

while($id_rows = mysqli_fetch_assoc($myresult))
{
  $id = $id_rows['category_id'];
...
<p> To insert a category please fill the following attributes</p>


<form action="insertcategory.php" method="POST">

<br>
<label for="category">Please enter the category information:</label> <br>
<input id="textboxid" type="text" name="id" placeholder="ID of the category"><br>
<input id="textboxid" type="text" name="name" placeholder="Name of the category"><br>
