...
<nav style="background-color:#DAD4E4;" class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="admincompanies.php">Production Companies</a>
        </li>
        <li class="nav-item">
...
<p>Available Companies in the database are as follows: </p>
...
include('info/companies.php');

?>
<br>
<form action="deletecompany.php" method="POST">
<label for="ids">Please choose a company id from the list to delete from the database</label>
<br>
<select name="ids">
...
$sql_command = "SELECT company_id FROM productioncompany";

$myresult = mysqli_query($db, $sql_command);

while($id_rows = mysqli_fetch_assoc($myresult))
{
  $id = $id_rows['company_id'];
...
<p> To insert a company please fill the following attributes</p>


<form action="insertcompany.php" method="POST">

<br>
<label for="company">Please enter the company information:</label> <br>
<input id="textboxid" type="text" name="id" placeholder="ID of the company"><br>
<input id="textboxid" type="text" name="name" placeholder="Name of the company"><br>
