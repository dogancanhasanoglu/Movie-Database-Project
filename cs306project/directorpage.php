...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="directorpage.php">Directors</a>
        </li>
        <li class="nav-item">
        ...
        <div class="container-fluid">
          ...
          if (mysqli_num_rows($result)>0) {
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-12">
                <h2> <?php echo $row['director_name']; ?></h2>
                <div class="caption">
                      <br>
                      <h5 class="group inner list-group-item-text">
                          Age: <?php echo $row['director_age']; ?></h5>
                      <h5 class="group inner list-group-item-text">
                          Nationality: <?php echo $row['nationality']; ?></h5>
                      <h5 class="group inner list-group-item-text">
                          Biography:</h5>
                      <h5 class="py-3"><?php echo $row['bio']; ?></h5>
